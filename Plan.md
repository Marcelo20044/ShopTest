...
* Ввести в поле Номера Карты номер отклонённой карты (ввести `4444 4444 4444 4442`, остальные поля заполнить валидными данными). Ожидаемый результат: транзакция произойдёт, в базе данных будет отображаться статус "отклонённый"
